  ...
  return (
    <>
      <SEOHead
        ...
        description="הכירו את צוות קי האוס - 13 שנות ניסיון בשוק הנדל״ן האילתי, מאות לקוחות מרוצים, ושירות ברמה הגבוהה ביותר. רותם קהלון ושירז קהלון מובילות את אחד ממשרדי התיווך המובילים באילת."
        canonical="/about"
        keywords={[
          'אודות',
          'רותם קהלון',
