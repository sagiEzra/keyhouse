    ...
    <main dir="rtl" className="min-h-screen bg-white">
      ...
      >
        <ChecklistContent
          items={[
            ...
            { text: "יחד איתך - מציאת הנכס האחד המתאים בדיוק לך" },
            { text: "חיבור עם אנשי מקצוע אמינים שילוו את העסקה בתחומים הנדרשים (משפטיים, פיננסיים וכד'), בשיתוף מלא וחלק איתנו" }
          ]}
        />
      </ServiceSection>
      ...
      <StatsSection
        ...
        stats={[
          ...
          { value: 51, label: "קנו איתנו יותר מפעם אחת", type: 'precentage' },
