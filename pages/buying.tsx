  ...
  return (
    <main dir="rtl" className="min-h-screen bg-white">
        ...
        <div className="mt-6">
          ...
          >
            ...
            <p className="mt-2" style={{ color: "#23214a" }}>
              עם ניסיון של מעל לעשור בשוק הנדל״ן באילת, רשת קשרים ענפה ומוניטין מוכח, אנחנו יכולים להציע לך הזדמנויות
      ...
      <StatsSection
        ...
        stats={[
          { value: 93, label: "מהלקוחות שלנו מוצאים את הנכס המושלם תוך 60 יום", type: 'precentage' },
